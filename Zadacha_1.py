...
Так как площадь конического сопла не изменятеся, то A_c2 = A_c1
Предроложим, что скорость не изменяется (W_c2 = W_c1), следовательно расход будет зависеть от изменения плотности'''
